...
async function run({ interaction }) {
    try {
        ...
        if (entries > defaultConfig_1.GOLDEN_JACKPOT_MAX_SIMULATE_ENTRIES) {
            return interaction.editReply({
                content: `The maximum number of entries is **${(0, utils_1.formatNumberToReadableString)(defaultConfig_1.GOLDEN_JACKPOT_MAX_SIMULATE_ENTRIES)}**.`,
            });
        }
