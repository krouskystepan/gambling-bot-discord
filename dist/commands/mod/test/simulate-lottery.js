...
async function run({ interaction }) {
    try {
        ...
        if (entries > gambling_bot_shared_1.LOTTERY_MAX_SIMULATE_ENTRIES) {
            return interaction.editReply({
                content: `The maximum number of entries is ${(0, utils_1.formatNumberToReadableString)(gambling_bot_shared_1.LOTTERY_MAX_SIMULATE_ENTRIES)}.`,
            });
        }
