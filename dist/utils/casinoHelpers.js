import { LOTTERY_NUM_TO_DRAW, LOTTERY_TOTAL_NUMBERS, MINI_NUMBERS } from 'gambling-bot-shared';
...
export const spinRouletteWheel = () => {
    const keys = Object.keys(MINI_NUMBERS);
    const index = Math.floor(Math.random() * keys.length);
    return keys[index];
};
export const drawNextCard = (deck, cardIndex) => {
