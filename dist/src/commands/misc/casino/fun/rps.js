...
async function run({ interaction }) {
    try {
        ...
        const realWinAmount = parsedBetAmount * (1 - casinoConfig_1.RPS_CASINO_CUT);
        ...
        const reply = await interaction.reply({
            content: `${targetDiscordUser}, you’ve been challenged by ${interaction.user} to a game of Rock, Paper, Scissors for **$${(0, utils_1.formatNumberToReadableString)(parsedBetAmount)}**!\nChoose one of the options to start the game.`,
            embeds: [embed],
            components: [row],
        });
